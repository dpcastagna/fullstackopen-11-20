...
const Notification = ({ message }) => {
  ...
  console.log('includes removed', message.toLowerCase().includes('removed')) // eslint-disable-line no-console
...
const App = () => {
  ...
  useEffect(() => {
    console.log('effect') // eslint-disable-line no-console
    personService
      .getAll()
      .then(response => {
  ...
  const addName = (event) => {
    ...
    persons.forEach(person => {
      if (person.name === newName){
        found = true
        console.log('found same name') // eslint-disable-line no-console
      }
    })
    ...
    if(found){
      ...
      if (result){
        ...
        personService
          ...
          .then(response => {
            console.log('päivitetty') // eslint-disable-line no-console
          ...
          .catch(error => {
            ...
            console.log('catchissa', error) // eslint-disable-line no-console
  ...
  const removePerson = (id) => {
    ...
    console.log('remove result', result) // eslint-disable-line no-console
    if (result) {
      personService
        .remove(person.id)
        .then(response => { // eslint-disable-line no-unused-vars
          console.log('poistettu') // eslint-disable-line no-console
